...
<body>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item fs-5">
                        <a class="nav-link active cc-active-link" aria-current="page"
                            href="customersPlaceOrderDashboard.php">Place an order</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="cc-div-styles cc-div1 p-3 px-5 rounded-4 shadow-lg ">
        <p>Popberry wine</p>
        <div> <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#orderModal">
                Order
            </button></div>
    </div>
